...
namespace Blog.Controllers
{
    public class MakaleController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,KullaniciAd,Baslik,Resim,Aciklama,YayinTarihi,Goruntulenme,Onay,KategoriId")] Makale makale)
        {
